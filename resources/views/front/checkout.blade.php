                                        ...
                                        <div class="row">
                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-input form">
                                                            <x-form.input name="addr[pilling][first_name]"
                                                                type="text" placeholder="First Name" />
                                                        </div>
                                                        <div class="col-md-6 form-input form">
                                                            {{-- <input type="text" name="last_name" placeholder="Last Name"> --}}
                                                            <x-form.input name="addr[pilling][last_name]" type="text"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[pilling][email]" type="text"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[pilling][phone_number]" type="text"
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[pilling][mailing_address]"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input type="text" name="addr[pilling][postal_code]"
                                                            placeholder='Post Coed' />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="select-items">
                                                        <select class="form-control" name="addr[pilling][state]">
                                                            ...
                                                            <option value="cairo"
                                                                {{ old($doted_name) == 'cairo' ? 'selected' : '' }}>Cairo
                                                            </option>
                                                            <option value="giza"
                                                                {{ old($doted_name) == 'giza' ? 'selected' : '' }}>Giza
                                                            </option>
                                                            <option value="upper_egypt"
                                                                {{ old($doted_name) == 'upper_egypt' ? 'selected' : '' }}>
                                                                Upper Egypt</option>
                                                            <option value="alex"
                                                                {{ old($doted_name) == 'alex' ? 'selected' : '' }}>
                                                                Alexandria</option>
                                                            <option value="sinai"
                                                                {{ old($doted_name) == 'sinai' ? 'selected' : '' }}>Sinai
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    <label>Mailing Address</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[shipping][mailing_address]"
                        ...
                        <div class="checkout-sidebar-price-table mt-30">
                            ...
                            <div class="sub-total-price">
                                <div class="total-price">
                                    ...
                                    <p class="price">{{ Currency::formate($cart->total(), config('app.currency')) }}
                                    </p>
                                </div>
